...
class ChannelMapper {
  static db.ChannelsCompanion toCompanion(Channel channel) {
    return db.ChannelsCompanion(
      ...
      totalMsgCountRoot: Value(channel.totalMsgCountRoot),
      msgCountRoot: Value(channel.msgCountRoot),
      mentionCountRoot: Value(channel.mentionCountRoot),
      urgentMentionCount: Value(channel.urgentMentionCount),
  ...
  static ChannelModel fromEntry(db.Channel entry) {
    return ChannelModel(
      ...
      totalMsgCountRoot: entry.totalMsgCountRoot,
      msgCountRoot: entry.msgCountRoot,
      mentionCountRoot: entry.mentionCountRoot,
      urgentMentionCount: entry.urgentMentionCount,
