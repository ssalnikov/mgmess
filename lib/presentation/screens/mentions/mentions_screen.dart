...
class _MentionsScreenState extends State<MentionsScreen> {
  late final MentionsBloc _bloc;

  @override
  void initState() {
    super.initState();
    _bloc = MentionsBloc(postRepository: currentSession.postRepository);
    _load();
  }
...
class _MentionTile extends StatelessWidget {
  ...
  const _MentionTile({required this.post});
